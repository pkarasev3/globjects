...
int main(int /*argc*/, char * /*argv*/[])
{
    ...
    std::vector<std::shared_ptr<Buffer>> buffers{ std::shared_ptr<Buffer>(new Buffer()), std::shared_ptr<Buffer>(new Buffer())};
